      ...
      <body className="min-h-full flex flex-col bg-slate-50 text-slate-900">
        <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm shadow-sm">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            <div>
              ...
              <p className="text-xl font-semibold text-slate-900">Proposal Maker</p>
            </div>
        ...
        <footer className="border-t border-slate-200 bg-white">
          <div className="mx-auto flex max-w-7xl items-center justify-center px-6 py-4">
            <p className="text-sm text-slate-500">Atoz Advert Proposal Maker • © Copyright {currentYear}</p>
          </div>
        </footer>
      </body>
    </html>
